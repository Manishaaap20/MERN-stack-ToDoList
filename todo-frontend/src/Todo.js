 ...
 const handleDelete =(id) =>{
  ...
  return <>
      <div className="row p-3 bg-success text-light">
        <h4>ToDo project MERN stack development basics</h4>
      </div>
      <div className="row">
        <h3>Add Item</h3>
      ...
      <div className="row mt-3">
        ...
        <ul className="list-group">
            {
                todos.map((item)=>  <li className="list-group-item  bg-primary d-flex justify-content-between align-items-center my-2">
